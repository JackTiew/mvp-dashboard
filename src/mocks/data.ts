...
export const mockDashboard: DashboardData = {
	...
	tasks: [
		{
			key: '1',
			title: 'Review quotation Q-2025-017',
			dueDate: 'Today',
		},
		{
			key: '2',
			title: 'Approve campaign amendment',
			dueDate: 'Tomorrow',
		},
		{
			key: '3',
		...
		{
			key: '4',
			title: 'Incident follow-up review',
			dueDate: 'In 3 days',
		},
	],
	detailedIncidents: [
	...
	requestsOverTime: {
		...
		values: [45, 52, 48, 65, 58, 70],
	},
	integrityTrend: {
		labels: ['Oct', 'Nov', 'Dec', 'Jan', 'Feb', 'Mar'],
		values: [72, 75, 78, 80, 82, 84],
	},
	governanceActivities: {
		labels: ['Oct', 'Nov', 'Dec', 'Jan', 'Feb', 'Mar'],
		values: [25, 32, 38, 35, 42, 45],
	},
	aiInsight: {
		title: 'Weekly governance summary',
		points: [
			'Governance score improved by 4.3 points this quarter.',
			'Sales and Marketing remain the highest-risk functions.',
			'Two high-severity incidents reopened for follow-up.',
		],
		footer: 'Generated by IntegrityOS – Executive can customise focus areas.',
	},
};
